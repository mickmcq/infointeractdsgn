---
title: Info & Interaction Design<br>Personas
author: Mick McQuaid
date: today
...
# But first ... A year ago last week ...
...
- Isn't it possible that this acquisition will fail? (Yes) [(No)]{.emph}
- Might the FTC block the deal? (Unlikely) [(they didn't)]{.emph}
...
- Contextual Inquiry
- Mood boards
- Triangles (oops! let's do them now)
- Picking up a key

# Your version of the triangle
![](fiTriangle.png){fig-align="center"}

Place yourself and your preferred job title in the triangle, wherever you belong, and include the vertices.
Submit a photo of it to Canvas.
...
# Up next, small group contextual inquiry
