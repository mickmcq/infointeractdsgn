...
\mysubsection{Materials You Need}\label{materials-you-need}}
...
Please use pencil for the notebook. The characteristics of a pencil
...
\mysubsection{Definitions}\label{definitions}}
...
Defining information is the subject of a lot of fighting among people
who get paid by the word. Some valuable information about information
...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{From}\NormalTok{ The Collaborative International Dictionary}
\ExtensionTok{of}\NormalTok{ English v.0.48 [gcide]:}

  \ExtensionTok{Information} \DataTypeTok{\textbackslash{}I}\NormalTok{n}\KeywordTok{\textasciigrave{}}\ControlFlowTok{for}\ExtensionTok{*ma}\StringTok{"tion\textbackslash{}, n. [F., fr. L.}
\StringTok{     information representation, conception.}
\StringTok{     See \{Inform\}, v. t.]}
\StringTok{     1. The act of informing, or communicating knowledge}
\StringTok{        or intelligence.}
\StringTok{        [1913 Webster]}
\StringTok{              The active informations of the intellect.}
\StringTok{                {-}{-}South.}
\StringTok{        [1913 Webster]}

\StringTok{     2. Any fact or set of facts, knowledge, news, or}
\StringTok{        advice, whether communicated by others or}
\StringTok{        obtained by personal study and investigation;}
\StringTok{        any datum that reduces uncertainty about the}
\StringTok{        state of any part of the world;}
\StringTok{        intelligence; knowledge derived from reading,}
\StringTok{        observation, or instruction.}
\StringTok{        [1913 Webster +PJC]}
\StringTok{              Larger opportunities of information.}
\StringTok{                {-}{-}Rogers.}
\StringTok{        [1913 Webster]}
\StringTok{              He should get some information in the}
\StringTok{              subject he intends to handle.}
\StringTok{                {-}{-}Swift.}
\StringTok{        [1913 Webster]}

\StringTok{     3. (Law) A proceeding in the nature of a prosecution}
\StringTok{        for some offense against the government,}
\StringTok{        instituted and prosecuted, really or nominally,}
\StringTok{        by some authorized public officer on behalf of}
\StringTok{        the government. It differs from an indictment in}
\StringTok{        criminal cases chiefly in not being based on the}
\StringTok{        finding of a grand jury. See \{Indictment\}.}
\StringTok{        [1913 Webster]}

\StringTok{     4. (Information Theory) A measure of the number of}
\StringTok{        possible choices of messages contained in a}
\StringTok{        symbol, signal, transmitted message, or other}
\StringTok{        information{-}bearing object; it is usually}
\StringTok{        quantified as the negative logarithm of the}
\StringTok{        number of allowed symbols that could be}
\StringTok{        contained in the message; for logarithms to the}
\StringTok{        base 2, the measure corresponds to the unit of}
\StringTok{        information, the hartley, which is log210, or}
\StringTok{        3.323 bits; called also \{information content\}.}
\StringTok{        The smallest unit of information that can be}
\StringTok{        contained or transmitted is the bit,}
\StringTok{        corresponding to a yes{-}or{-}no decision.}

\StringTok{     5. (Computers) Useful facts, as contrasted with}
\StringTok{        raw data; as, among all this data, there must}
\StringTok{        be some interesting information.}
\StringTok{        [PJC]}

\StringTok{From WordNet (r) 3.0 (2006) [wn]:}

\StringTok{  information}
\StringTok{      n 1: a message received and understood}
\StringTok{           [syn: \{information\}, \{info\}]}
\StringTok{        2: knowledge acquired through study or}
\StringTok{           experience or instruction}
\StringTok{        3: formal accusation of a crime}
\StringTok{        4: a collection of facts from which}
\StringTok{           conclusions may be drawn;}
\StringTok{           "}\ExtensionTok{statistical}\NormalTok{ data}\StringTok{"}
\StringTok{           [syn: \{data\}, \{information\}]}
\StringTok{        5: (communication theory) a numerical measure}
\StringTok{           of the uncertainty of an outcome; "}\NormalTok{the signal}
           \ExtensionTok{contained}\NormalTok{ thousands of bits of information}\StringTok{"}
\StringTok{           [syn: \{information\}, \{selective information\},}
\StringTok{            \{entropy\}]}

\StringTok{From The Free On{-}line Dictionary of Computing}
\StringTok{     (20 July 2014) [foldoc]:}

\StringTok{  information}

\StringTok{     \textless{}data\textgreater{} The result of applying \{data processing\} to}
\StringTok{     \{data\}, giving it context and meaning.  Information}
\StringTok{     can then be further processed to yield \{knowledge\}.}

\StringTok{     People or computers can find patterns in data to}
\StringTok{     perceive information, and information can be used}
\StringTok{     to enhance \{knowledge\}.  Since knowledge is}
\StringTok{     prerequisite to wisdom, we always want more data}
\StringTok{     and information.  But, as modern societies verge}
\StringTok{     on \{information overload\}, we especially need}
\StringTok{     better ways to find patterns.}

\StringTok{     1234567.89 is data.}

\StringTok{     "}\NormalTok{Your bank balance has jumped 8087\% to }\VariableTok{$1}\NormalTok{234567.89}\StringTok{"}
\StringTok{     is information.}

\StringTok{     "}\NormalTok{Nobody owes me that much money}\StringTok{" is knowledge.}

\StringTok{     "}\NormalTok{I}\StringTok{\textquotesingle{}d better talk to the bank before I spend it,}
\StringTok{     because of what has happened to other people"}
\StringTok{     is wisdom.}

\StringTok{     (2007{-}09{-}10)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{groups}{%
\mysubsection{Groups}\label{groups}}
...
\hypertarget{grading}{%
\mysubsection{Grading}\label{grading}}
...
Second, there is the question of the difference between your work and
...
One of my own mentors said you can't effectively judge your own past for
...
\mysubsection{Whether perfect should be
average}\label{whether-perfect-should-be-average}}
...
I (Mick) strongly believe in quantitative information. When people say
...
\mysubsection{Powerlesspoint}\label{powerlesspoint}}
...
The second is actually a video. Visit Youtube and search for pixar
...
\hypertarget{background-radiation}{%
\mysection{Background Radiation}\label{background-radiation}}

\hypertarget{roles}{%
\mysubsection{Roles}\label{roles}}
...
The vertices of the triangle represent emphases or influences. The job
...
\hypertarget{people}{%
\mysubsection{People}\label{people}}
...
Business partner of Don Norman, author of influential evaluation
...
Son of Jeff, has participated in high-profile startups and is a popular
...
The same can be said of institutions. Many institutions have
...
\mysubsection{Institutions}\label{institutions}}
...
\mysubsection{Technologies}\label{technologies}}
...
\mysubsection{Design Guidelines from
Vendors}\label{design-guidelines-from-vendors}}
...
\href{https://developer.apple.com/design/human-interface-guidelines/}{Apple
...
Plenty of online tools are part of a typical designer's workday, such as
...
I use Wikipedia as a reference for many topics. For instance, the
...
\mysubsection{Being the center of the
universe}\label{being-the-center-of-the-universe}}
...
Back to my anecdote \ldots{} The intrepid developer of the Conductor
...
The presenter blathered on about poverty for quite some time, finally
...
\mysection{Audience}\label{audience}}

\hypertarget{academic-communities}{%
\mysubsection{Academic Communities}\label{academic-communities}}
...
\emph{Human factors} is usually the experimental study of how people
...
Communities that can function remotely, such as Facebook, are the focus
...
\mysubsection{Industrial and Government
Communities}\label{industrial-and-government-communities}}
...
\mysubsection{Historical perspective}\label{historical-perspective}}
...
\mysubsection{Idealized user}\label{idealized-user}}
...
\mysubsection{Nondiscretionary use}\label{nondiscretionary-use}}
...
\mysubsection{Hierarchical
collaboration}\label{hierarchical-collaboration}}
...
\hypertarget{workgroup-cooperation}{%
\mysubsection{Workgroup cooperation}\label{workgroup-cooperation}}
...
\mysubsection{Discretionary computing}\label{discretionary-computing}}
...
\mysubsection{Ubiquitous computing}\label{ubiquitous-computing}}
...
\mysubsection{Communities of Practice}\label{communities-of-practice}}
...
\mysubsection{Communities of Life}\label{communities-of-life}}
...
A clearer picture of community development comes from speaking directly
...
It is very difficult to avoid stovepiping in community development as it
...
The project was a resounding failure because she did not understand
...
To summarize, communities of life can be served by HCI, but not without
...
\mysubsection{Disability-specific
design}\label{disability-specific-design}}
...
\mysubsection{Popularization via bad
design}\label{popularization-via-bad-design}}
...
Most bad design examples remind us of the importance of affordances and
...
\hypertarget{bad-ipads-ancestor}{%
...
\mysection{Interaction Design}\label{interaction-design}}
...
\mysubsection{Contextual Design}\label{contextual-design}}
...
\mysubsection{Three ways to study users}\label{three-ways-to-study-users}}
...
\mysubsection{Contextual inquiry}\label{contextual-inquiry}}
...
\mysubsection{Participatory design}\label{participatory-design}}
...
\mysubsection{Ethnography}\label{ethnography}}
...
\mysection{Contextual Inquiry Process}\label{contextual-inquiry-process}}
...
\mysubsection{Immersion}\label{immersion}}
...
\mysubsection{Share interview
techniques}\label{share-interview-techniques}}
...
The most typical problem students have in interviews is that they fear
...
\hypertarget{protocol-and-verbal-analysis}{%
\mysubsection{Protocol and verbal
analysis}\label{protocol-and-verbal-analysis}}
...
\mysection{Personas and Scenarios}\label{personas-and-scenarios}}
...
Most of the items in the list are self-explanatory. The last one,
...
\mysection{Prototyping}\label{prototyping}}
...
\mysubsection{Iterative development}\label{iterative-development}}
...
\mysubsection{Iterative model diagram}\label{iterative-model-diagram}}
...
\hypertarget{expense-of-iterative-development}{%
\mysubsection{Expense of iterative
development}\label{expense-of-iterative-development}}

This method is inherently more expensive than the waterfall method for a
given size of computer program.\\
That is often difficult for students to understand because the waterfall
method is usually employed when larger computer programs are
contemplated. Therefore it must seem that the average cost of a program
developed via the waterfall method is more expensive than the average
cost of a program developed via the iterative method. Such an intuition
is good but it ignores the fact that people know the iterative method
costs more per line of computer code, so they simply don't use it on
large programs except under certain specific conditions.

\hypertarget{lack-of-planning-detail-in-iterative-method}{%
\mysubsection{Lack of planning detail in iterative
method}\label{lack-of-planning-detail-in-iterative-method}}

The expense of the iterative method involves several factors. One is
...
\mysubsection{Extra products of the iterative
method}\label{extra-products-of-the-iterative-method}}
...
\mysubsection{Getting everyone on the same
page}\label{getting-everyone-on-the-same-page}}
...
\mysubsection{Evaluation in iterative
development}\label{evaluation-in-iterative-development}}

\noindent \llap{``}I had a guaranteed military sale with ED 209 -
...
\mysubsection{Another perspective on
iteration}\label{another-perspective-on-iteration}}
...
\mysubsection{Fidelity of prototyping}\label{fidelity-of-prototyping}}

Prototypes are often categorized according to how true they are to the
...
\mysubsection{Paper prototyping}\label{paper-prototyping}}
...
\mysubsection{Your second prototype}\label{your-second-prototype}}
...
\hypertarget{design-as-an-input-to-a-prototype}{%
\mysubsection{Design as an input to a
prototype}\label{design-as-an-input-to-a-prototype}}
...
\mysubsection{Alternative generation}\label{alternative-generation}}
...
If software won't help with alternative generation, what will? The most
...
\mysubsection{Choices reflecting
constraints}\label{choices-reflecting-constraints}}

Charles Eames once said that design is all about constraints. The way he
...
Although the above examples are military, the lesson is not by any means
...
\mysubsection{Implementation}\label{implementation}}
...
\mysubsection{Craftsmanship}\label{craftsmanship}}
...
\mysubsection{Social presence}\label{social-presence}}
...
You must also consider the problem of manipulation of social presence
...
\mysubsection{Form factor}\label{form-factor}}
...
\mysubsection{Project focus}\label{project-focus}}
...
\mysection{Personal Information}\label{personal-information}}
...
\mysubsection{Personal information
systems}\label{personal-information-systems}}
...
\mysubsection{Knives in the home}\label{knives-in-the-home}}
...
When you need a particular knife, it will be in the context of a current
...
\mysubsection{Filing: using hierarchies to organize
information}\label{filing-using-hierarchies-to-organize-information}}
...
\mysubsection{Piling: using tags to organize
information}\label{piling-using-tags-to-organize-information}}
...
What's problematic about such a system? One issue is that a given user
...
\mysubsection{Exercise: share best
practices}\label{exercise-share-best-practices}}
...
Some valuable readings can be found at the following URLs. These were
...
\mysubsection{Advice on PKM}\label{advice-on-pkm}}
...
One major issue raised by many of these posters is the problem of link
...
\mysection{Information}\label{information}}
...
Both these experiments and similar ones are described online under
...
\mysubsection{Unstructured information}\label{unstructured-information}}
...
\hypertarget{semistructured-information}{%
\mysubsection{Semistructured
information}\label{semistructured-information}}
...
\mysubsection{Structured information}\label{structured-information}}
...
\mysubsection{Relational data}\label{relational-data}}
...
\mysubsection{Hierarchical data}\label{hierarchical-data}}
...
\begin{Highlighting}[]
 \ExtensionTok{Sender}
   \ExtensionTok{Sender}\NormalTok{ Name}
   \ExtensionTok{Sender}\NormalTok{ Address}
   \ExtensionTok{Sender}\NormalTok{ Account Number}
 \ExtensionTok{Recipient}
   \ExtensionTok{Recipient}\NormalTok{ Name}
   \ExtensionTok{Recipient}\NormalTok{ Address}
 \ExtensionTok{Commodities}
   \ExtensionTok{Commodity}\NormalTok{ 1}
     \ExtensionTok{Quantity}
     \ExtensionTok{Unit}\NormalTok{ / Number}
     \ExtensionTok{Weight}
     \ExtensionTok{Value}
   \ExtensionTok{Commodity}\NormalTok{ 2}
     \ExtensionTok{Quantity}
     \ExtensionTok{Unit}\NormalTok{ / Number}
     \ExtensionTok{Weight}
     \ExtensionTok{Value}
 \ExtensionTok{Authorization}
\end{Highlighting}
\end{Shaded}

A key characteristic of this hierarchical form is that it can present
...
\mysubsection{Big data}\label{big-data}}
...
\hypertarget{memes}{%
\mysubsection{Memes}\label{memes}}
...
\mysubsection{Organizing information}\label{organizing-information}}

Designers use an almost folkloric understanding of how people organize
...
\mysubsection{Labeling}\label{labeling}}
...
\mysubsection{Card sorting}\label{card-sorting}}
...
\mysubsection{Interrater reliability}\label{interrater-reliability}}
...
Why should you use this measure of interrater reliability? The problem
...
\NormalTok{rater1 }\OtherTok{\textless{}{-}} \FunctionTok{rbinom}\NormalTok{(}\AttributeTok{n =}\NormalTok{ N, }\AttributeTok{size =} \DecValTok{1}\NormalTok{, }\AttributeTok{prob =}\NormalTok{ theta)}
\NormalTok{rater2 }\OtherTok{\textless{}{-}} \FunctionTok{rbinom}\NormalTok{(}\AttributeTok{n =}\NormalTok{ N, }\AttributeTok{size =} \DecValTok{1}\NormalTok{, }\AttributeTok{prob =}\NormalTok{ theta)}
\NormalTok{twentyitems }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(rater1, rater2)}
\NormalTok{twentyitems}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{      rater1 rater2}
\NormalTok{ [}\DecValTok{1}\NormalTok{,]      }\DecValTok{0}      \DecValTok{0}
\NormalTok{ [}\DecValTok{2}\NormalTok{,]      }\DecValTok{0}      \DecValTok{0}
\NormalTok{ [}\DecValTok{3}\NormalTok{,]      }\DecValTok{1}      \DecValTok{0}
\NormalTok{ [}\DecValTok{4}\NormalTok{,]      }\DecValTok{1}      \DecValTok{0}
\NormalTok{ [}\DecValTok{5}\NormalTok{,]      }\DecValTok{0}      \DecValTok{0}
\NormalTok{ [}\DecValTok{6}\NormalTok{,]      }\DecValTok{1}      \DecValTok{1}
\NormalTok{ [}\DecValTok{7}\NormalTok{,]      }\DecValTok{1}      \DecValTok{1}
\NormalTok{ [}\DecValTok{8}\NormalTok{,]      }\DecValTok{1}      \DecValTok{0}
\NormalTok{ [}\DecValTok{9}\NormalTok{,]      }\DecValTok{0}      \DecValTok{1}
\NormalTok{[}\DecValTok{10}\NormalTok{,]      }\DecValTok{0}      \DecValTok{1}
\NormalTok{[}\DecValTok{11}\NormalTok{,]      }\DecValTok{1}      \DecValTok{0}
\NormalTok{[}\DecValTok{12}\NormalTok{,]      }\DecValTok{1}      \DecValTok{1}
\NormalTok{[}\DecValTok{13}\NormalTok{,]      }\DecValTok{0}      \DecValTok{0}
\NormalTok{[}\DecValTok{14}\NormalTok{,]      }\DecValTok{1}      \DecValTok{0}
\NormalTok{[}\DecValTok{15}\NormalTok{,]      }\DecValTok{0}      \DecValTok{0}
\NormalTok{[}\DecValTok{16}\NormalTok{,]      }\DecValTok{0}      \DecValTok{1}
\NormalTok{[}\DecValTok{17}\NormalTok{,]      }\DecValTok{0}      \DecValTok{0}
\NormalTok{[}\DecValTok{18}\NormalTok{,]      }\DecValTok{1}      \DecValTok{0}
\NormalTok{[}\DecValTok{19}\NormalTok{,]      }\DecValTok{0}      \DecValTok{0}
\NormalTok{[}\DecValTok{20}\NormalTok{,]      }\DecValTok{0}      \DecValTok{0}
\end{Highlighting}
\end{Shaded}

You can see that there is plenty of agreement and plenty of disagreement
between the two raters from the above table. Now load the \texttt{irr}
package to first see how much the two raters agreed.

\begin{Shaded}
\begin{Highlighting}[]
\ControlFlowTok{if}\NormalTok{ (}\SpecialCharTok{!}\FunctionTok{require}\NormalTok{(irr)) \{}
  \FunctionTok{install.packages}\NormalTok{(}\StringTok{"irr"}\NormalTok{)}
  \FunctionTok{library}\NormalTok{(irr)}
\NormalTok{\}}
\FunctionTok{agree}\NormalTok{(twentyitems,}\AttributeTok{tolerance=}\DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

The output of \texttt{agree()} is as follows.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ Percentage }\FunctionTok{agreement}\NormalTok{ (}\AttributeTok{Tolerance=}\DecValTok{0}\NormalTok{)}

\NormalTok{ Subjects }\OtherTok{=} \DecValTok{20}
\NormalTok{   Raters }\OtherTok{=} \DecValTok{2}
\NormalTok{  \%}\SpecialCharTok{{-}}\NormalTok{agree }\OtherTok{=} \DecValTok{55}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{kappa2}\NormalTok{(twentyitems)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ Cohen}\StringTok{\textquotesingle{}s Kappa for 2 Raters (Weights: unweighted)}

\StringTok{ Subjects = 20}
\StringTok{   Raters = 2}
\StringTok{    Kappa = 0.0625}

\StringTok{        z = 0.294}
\StringTok{  p{-}value = 0.769}
\end{Highlighting}
\end{Shaded}
...
You may be able to guess that the hardest part of this process is coding
...
\NormalTok{rater1 }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(}\FunctionTok{runif}\NormalTok{(}\AttributeTok{n =}\NormalTok{ N, }\AttributeTok{min =} \DecValTok{1}\NormalTok{, }\AttributeTok{max =} \DecValTok{5}\NormalTok{))}
\NormalTok{rater2 }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(}\FunctionTok{runif}\NormalTok{(}\AttributeTok{n =}\NormalTok{ N, }\AttributeTok{min =} \DecValTok{1}\NormalTok{, }\AttributeTok{max =} \DecValTok{5}\NormalTok{))}
\NormalTok{rater3 }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(}\FunctionTok{runif}\NormalTok{(}\AttributeTok{n =}\NormalTok{ N, }\AttributeTok{min =} \DecValTok{1}\NormalTok{, }\AttributeTok{max =} \DecValTok{5}\NormalTok{))}
\NormalTok{rater4 }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(}\FunctionTok{runif}\NormalTok{(}\AttributeTok{n =}\NormalTok{ N, }\AttributeTok{min =} \DecValTok{1}\NormalTok{, }\AttributeTok{max =} \DecValTok{5}\NormalTok{))}
\NormalTok{fiveitems }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(rater1, rater2, rater3, rater4)}
\NormalTok{fiveitems }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{     rater1 rater2 rater3 rater4}
\NormalTok{[}\DecValTok{1}\NormalTok{,]      }\DecValTok{2}      \DecValTok{5}      \DecValTok{1}      \DecValTok{2}
\NormalTok{[}\DecValTok{2}\NormalTok{,]      }\DecValTok{4}      \DecValTok{2}      \DecValTok{3}      \DecValTok{5}
\NormalTok{[}\DecValTok{3}\NormalTok{,]      }\DecValTok{3}      \DecValTok{4}      \DecValTok{3}      \DecValTok{4}
\NormalTok{[}\DecValTok{4}\NormalTok{,]      }\DecValTok{4}      \DecValTok{2}      \DecValTok{3}      \DecValTok{4}
\NormalTok{[}\DecValTok{5}\NormalTok{,]      }\DecValTok{3}      \DecValTok{4}      \DecValTok{1}      \DecValTok{3}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(irr)}
\FunctionTok{agree}\NormalTok{(fiveitems)}
\FunctionTok{kappam.fleiss}\NormalTok{(fiveitems)}
\FunctionTok{kappam.light}\NormalTok{(fiveitems)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ Subjects }\OtherTok{=} \DecValTok{5}
\NormalTok{   Raters }\OtherTok{=} \DecValTok{4}
\NormalTok{  \%}\SpecialCharTok{{-}}\NormalTok{agree }\OtherTok{=} \DecValTok{0}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ Fleiss}\StringTok{\textquotesingle{} Kappa for m Raters}

\StringTok{ Subjects = 5}
\StringTok{   Raters = 4}
\StringTok{    Kappa = {-}0.0965}

\StringTok{        z = {-}0.975}
\StringTok{  p{-}value = 0.329}
\end{Highlighting}
\end{Shaded}

The output for \texttt{kappam.light(fiveitems)} is

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ Light}\StringTok{\textquotesingle{}s Kappa for m Raters}

\StringTok{ Subjects = 5}
\StringTok{   Raters = 4}
\StringTok{    Kappa = {-}0.0286}

\StringTok{        z = NaN}
\StringTok{  p{-}value = NaN}
\StringTok{Warning message:}
\StringTok{In sqrt(varkappa) : NaNs produced}
\end{Highlighting}
\end{Shaded}
...
\mysubsection{Grouping}\label{grouping}}
...
\hypertarget{flat-and-hierarchical-grouping}{%
\mysubsection{Flat and hierarchical
grouping}\label{flat-and-hierarchical-grouping}}
...
\mysubsection{Automatic and supervised
grouping}\label{automatic-and-supervised-grouping}}
...
\mysubsection{Human computation}\label{human-computation}}
...
While human computation was hailed as the solution to spam ten years
ago, it has turned out to have some value and some unexpected
consequences.

\hypertarget{networked-information}{%
\mysubsection{Networked information}\label{networked-information}}
...
\mysubsection{Supply chain information}\label{supply-chain-information}}
...
When I say that XML is inefficient for detailed processing, I am
...
\mysection{Connecting Concepts}\label{connecting-concepts}}
...
\mysubsection{Understanding labels}\label{understanding-labels}}
...
\mysubsection{Learning navigational
behavior}\label{learning-navigational-behavior}}
...
One thing I may have neglected to mention is A-B testing, a common
...
\mysubsection{Social network influence on
navigation}\label{social-network-influence-on-navigation}}
...
\mysubsection{Information structure}\label{information-structure}}
...
\mysubsection{Flexibility of
representation}\label{flexibility-of-representation}}
...
\mysection{Information Design
Patterns}\label{information-design-patterns}}

We discussed several elements that information architecture authors have
...
\mysubsection{Design Pattern
Definitions}\label{design-pattern-definitions}}
...
\mysubsection{Design patterns were first
observed}\label{design-patterns-were-first-observed}}
...
\mysubsection{A Pattern Language}\label{a-pattern-language}}
...
\hypertarget{components-of-a-pattern-language}{%
\mysubsection{Components of a Pattern
Language}\label{components-of-a-pattern-language}}
...
\mysubsection{An example of a pattern is a place to
wait}\label{an-example-of-a-pattern-is-a-place-to-wait}}
...
\mysubsection{An example of a pattern is a useful cooking
layout}\label{an-example-of-a-pattern-is-a-useful-cooking-layout}}
...
\mysubsection{Computer scientists popularized design
patterns}\label{computer-scientists-popularized-design-patterns}}
...
\hypertarget{gang-of-four-book}{%
\mysubsection{Gang of Four book}\label{gang-of-four-book}}
...
\mysubsection{Gang of Four pattern
definition}\label{gang-of-four-pattern-definition}}
...
\mysubsection{A pattern has four things}\label{a-pattern-has-four-things}}
...
\mysubsection{A pattern name is a tool}\label{a-pattern-name-is-a-tool}}
...
\mysubsection{A problem may be of several
kinds}\label{a-problem-may-be-of-several-kinds}}
...
\hypertarget{a-solution-is-a-description-of-objects-and-classes}{%
\mysubsection{A solution is a description of objects and
classes}\label{a-solution-is-a-description-of-objects-and-classes}}
...
\mysubsection{A consequence is a result or
trade-off}\label{a-consequence-is-a-result-or-trade-off}}
...
\mysubsection{Design patterns in information
architecture}\label{design-patterns-in-information-architecture}}
...
\hypertarget{magic-fairy-dust}{%
\mysubsection{Magic fairy dust}\label{magic-fairy-dust}}
...
\mysection{Finding Information}\label{finding-information}}
...
\mysubsection{Search engines}\label{search-engines}}
...
Reading: Page and Brin, 1998. The PageRank Citation Ranking: Bringing
Order to the Web.
...
\mysubsection{Information scent}\label{information-scent}}
...
\mysubsection{Information credibility}\label{information-credibility}}
...
\mysubsection{Getting help}\label{getting-help}}
...
User communities spring up around successful computer applications and
...
\mysubsection{Exercise: comparing help for two
browsers}\label{exercise-comparing-help-for-two-browsers}}
...
\mysection{Navigating Information}\label{navigating-information}}
...
\mysubsection{Analytics}\label{analytics}}
...
You may even be subject to tracking right now of which you are unaware.
...
\mysubsection{Google analytics}\label{google-analytics}}
...
\mysubsection{Gaming the system}\label{gaming-the-system}}
...
There are fields of study joining computer science and economics called
...
\mysubsection{Metadata}\label{metadata}}
...
\mysubsection{Information Architecture}\label{information-architecture}}
...
\mysubsection{Information architecture
tools}\label{information-architecture-tools}}
...
\mysubsection{Information hiding}\label{information-hiding}}
...
You may notice that, when I display a browser window in class, there is
...
\mysubsection{Information comparison}\label{information-comparison}}
...
Seeing this phenomenon again and again over the years leads to me to ask
...
\mysubsection{Organizational maturity}\label{organizational-maturity}}
...
Proença and Borbinha (2016) surveys twenty-two information systems
...
\mysection{Visual Information}\label{visual-information}}

\hypertarget{visual-information-example}{%
\mysubsection{Visual information
example}\label{visual-information-example}}
...
\mysubsection{The Invariant}\label{the-invariant}}
...
Having critiqued the invariant and suggested a solution, I am in a
...
\mysubsection{The components}\label{the-components}}
...
Size has the order raw because it refers to number of employees rather
...
\mysubsection{Retinal Variables}\label{retinal-variables}}
...
County and NAICS are both described on the \emph{x} axis by the bar
...
\mysection{Visual Design of
Information}\label{visual-design-of-information}}

\hypertarget{different-perspectives-drive-different-views}{%
\mysubsection{Different perspectives drive different
views}\label{different-perspectives-drive-different-views}}
...
\noindent \llap{``}When art critics get together they talk about Form
...
\noindent \llap{``}Modern philosophers have had little to say about the
...
\hypertarget{essence}{%
\mysubsection{Essence}\label{essence}}
...
There are many ways to interpret the word essence in the above series
and I leave that to the essays mentioned above, that discuss the bull as
the essence of masculinity or of Spain itself. Let me just add this
proposed Olympics poster, undoubtedly influenced by Picasso in
particular and Cubism in general.
...
\mysubsection{Gestalt principles}\label{gestalt-principles}}

In 1923, Max Wertheimer published principles of visual grouping (in
German) as follows. These principles were later widely translated and
influenced people in a wide range of professions and cultures. The
Gestalt psychologists themselves made extensive contacts among artists
and scientists the world over. They were dispersed from Germany and
never re-coalesced into a group in their lifetimes so the magnitude of
their influence on others is not always clear in history books. In
addition to the following short list, they formulated many other
principles they shared with artists of the Bauhaus and famous scientists
...
\item
  common fate: images perceived to have common fate (follow a path) form
  a group
\item
...
\hypertarget{dieter-rams-1}{%
\mysubsection{Dieter Rams}\label{dieter-rams-1}}
...
\mysubsection{Edward Tufte}\label{edward-tufte-1}}
...
Tufte's work is characterized in part on a reliance on high-reso-lution
...
\mysubsection{Contemporary Perspectives on Design
Principles}\label{contemporary-perspectives-on-design-principles}}
...
\mysubsection{Get a GRIP and forget about
CRAP}\label{get-a-grip-and-forget-about-crap}}
...
\mysubsection{Changes in type over time}\label{changes-in-type-over-time}}
...
It was expensive for printers to purchase sets of type. Benjamin
...
That document was first published with Bodoni types by the Officina
...
\mysubsection{Challenges for type}\label{challenges-for-type}}
...
\mysubsection{Reading psychology}\label{reading-psychology}}
...
He responded that he believed that the human brain can generally
...
\mysubsection{Type in a menu}\label{type-in-a-menu}}
...
The menu provided for context includes fairy tales as among the contexts
...
Believe it or not, small caps differ from other capital letters. In a
...
Because of the early liturgical emphasis of typography, there are vastly
...
\mysubsection{Die Neue Typographie}\label{die-neue-typographie}}
...
\mysubsection{Chunking words, especially in
menus}\label{chunking-words-especially-in-menus}}
...
\hypertarget{color}{%
\mysubsection{Color}\label{color}}
...
\mysubsection{Education about color}\label{education-about-color}}
...
\mysubsection{Color word research}\label{color-word-research}}
...
\hypertarget{color-names-in-computing}{%
\mysubsection{Color names in computing}\label{color-names-in-computing}}

\href{http://arstechnica.com/information-technology/2015/10/tomato-versus-ff6347-the-tragicomic-history-of-css-color-names/}{arstechnica
on color name history} ran a sad and funny article in Fall 2015 on the
names of colors as used in computing, from the X Window System project
in the eighties through CSS3 today. Read this article for a lesson in
knowledge representation, inertia, standards bodies, rapid technical
progress, and computer history. One important detail that is passed over
too lightly is that people remember words like tomato better than
hexadecimal codes like FF6347. Memory for words and the underlying
phenomenon of spreading activation of neurons that leads to well-formed
searches are among the great drivers for Google. I would love to be able
to search for hexadecimal representations of color by word. Oh, wait! I
can! Check what google returns for \emph{tomato color}! The very second
hit when I tried it was for \emph{coloreminder}, a wonderful service
whose name I can not remember but which will appear for some of the less
obvious color names mentioned in the above article. For colors that men
can stereotypically not appreciate, like fuschia or puce, there is a
Wikipedia entry as the first result. By the way, a recent survey of
differences between men and women in naming colors found, contrary to
stereotype, that men and women seem to be able to appreciate almost
exactly as many colors as each other. Searching for it, I found a 2012
study that seems to say exactly the opposite. The devil may be in the
details.

\hypertarget{swim-lane-diagrams}{%
\mysubsection{Swim lane diagrams}\label{swim-lane-diagrams}}

Swim lane diagrams are used as a project management tool in IT. At a
minimum, they portray roles, tasks, and handoffs. The name
\textit{swim lane} arises because they look like a swimming pool divided
into lanes with a start and finish. Each role has a lane in the pool.
Each task is rectangle inside a lane. Each handoff is an arrow from one
lane to another.

Here is an example from
\href{http://www.processmodeling.info/posts/swimlane-lane-or-pool-learn-to-swim-first/}{processmodeling.info}
containing additional symbols specific to Unified Modeling Language.
...
This diagram shows three roles: accounting, hiring manager, and human
...
It may be better to visit alone or with another team mate. If you're
...
\mysubsection{An exemplary swim lane
diagram}\label{an-exemplary-swim-lane-diagram}}
...
I believe that she achieves this success through polishing her problem
...
\mysubsection{Bertin's Theory}\label{bertins-theory}}
...
\mysubsection{Theories}\label{theories}}
...
Note that Hawking is giving what we might call a normative definition,
...
\mysubsection{Efficiency}\label{efficiency}}
...
\mysubsection{Categories of information
graphics}\label{categories-of-information-graphics}}
...
\hypertarget{symbols}{%
\mysubsection{Symbols}\label{symbols}}
...
Here I am using the word flexible to mean that typographic glyphs are
...
\mysubsection{Diagrams}\label{diagrams}}
...
\mysubsection{Networks}\label{networks}}
...
\mysubsection{Simplification}\label{simplification}}
...
\mysection{Milestones}\label{milestones}}

Together, the following milestones constitute a project that determines
half of your grade.
...
time-consuming part of this course. Past project groups claim to have
spent up to 40 hours in meetings to plan and organize their projects,
with an enormous time commitment of solitary work between meetings.

The outcome of this project should be a digital prototype that can be
shared, preferably via the web. There should be a web presentation even
if the design itself is of something that is not inherently web-based,
such as an intelligent wheelchair. It should be possible to communicate
about the project outcome via the web, both for the class and so that
you can use the project outcome in job searching.

Our competitors do this, and you can sometimes find remarkable project
...
\mysubsection{Create a project website}\label{create-a-project-website}}
...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{sftp}\NormalTok{ mjmics@gibson.rit.edu}
\BuiltInTok{cd}\NormalTok{ www}
\ExtensionTok{put}\NormalTok{ index.html}
\BuiltInTok{exit}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ssh}\NormalTok{ mjmics@gibson.rit.edu}
\FunctionTok{chmod}\NormalTok{ 755 www}
\BuiltInTok{cd}\NormalTok{ www}
\FunctionTok{chmod}\NormalTok{ 755 index.html}
\BuiltInTok{exit}
\end{Highlighting}
\end{Shaded}

Again, you would substitute your username where I have entered mine
...
\mysubsection{Diverge, then converge}\label{diverge-then-converge}}
...
Making a deadline is a convergent process. You don't want to be open to
...
\mysubsection{Milestone 1. project
focus}\label{milestone-1.-project-focus}}
...
\mysubsection{Milestone 2. contextual
inquiry}\label{milestone-2.-contextual-inquiry}}
...
\hypertarget{revising-milestone-1}{%
...
Individuals need to conduct their interviews so they can be used in the
...
Note that there are four \emph{levels} of post-it notes. The lowest
...
The next step (step 3) is to build a temporary top level, largely
...
Use these boards and post-it notes and just bring the results to class
...
\hypertarget{milestone-3.-personas}{%
\mysubsection{Milestone 3. personas}\label{milestone-3.-personas}}
...
\mysubsection{Milestone 4. lo-fi
prototype}\label{milestone-4.-lo-fi-prototype}}
...
The lo-fi prototype should show the basic layout of screens but not
...
\mysubsection{Milestone 5. hi-fi
prototype}\label{milestone-5.-hi-fi-prototype}}
...
\mysubsection{Final project
presentation}\label{final-project-presentation}}

The thrust of this presentation will be to have conducted user testing
...
\mysubsection{Milestone critiques}\label{milestone-critiques}}
...
A famous quote from Henry Ford, explaining why he did not listen to his
customers was that, if he had, they would have just told him to invent a
better horse and buggy.

\hypertarget{project-management}{%
\mysubsection{Project management}\label{project-management}}
...
I had the good fortune to interview a vice president of BP in 2006 and
...
\mysection{Exercises}\label{exercises}}
...
\hypertarget{completing-exercises}{%
\mysubsection{Completing exercises}\label{completing-exercises}}
...
As we look through the pictures, you will notice that some have
...
How do you know whether you have played and produced? We spoke of the
...
Every single exercise from the picking up a key exercise until the last
...
\mysubsection{Exercise list}\label{exercise-list}}
...
\mysubsection{Draw a face}\label{draw-a-face}}
...
This exercise is drawn from the 1964 book \emph{Thinking with a pencil}
...
\mysubsection{Picking up a key}\label{picking-up-a-key}}
...
\mysubsection{Harrison Bergeron}\label{harrison-bergeron}}
...
\hypertarget{extreme-emphasis}{%
\mysubsection{Extreme emphasis}\label{extreme-emphasis}}
...
\mysubsection{Record interaction}\label{record-interaction}}
...
\hypertarget{identify-domains-and-skills}{%
\mysubsection{Identify domains and
skills}\label{identify-domains-and-skills}}
...
\mysubsection{Widget redesign}\label{widget-redesign}}
...
produce a picture in your notebook as the focus of the exercise. The
...
\mysubsection{Ambient notification}\label{ambient-notification}}
...
\mysubsection{Thousand floor elevator}\label{thousand-floor-elevator}}

Design an elevator for a building with 1,000 floors. This is a single
...
\mysubsection{Corporate directory
navigator}\label{corporate-directory-navigator}}
...
Your design should be shown in a series of sketches that work at QVGA
resolution and show interactions and their effects.

\hypertarget{business-card-calendar}{%
\mysubsection{Business card calendar}\label{business-card-calendar}}
...
\mysubsection{Signifier matrix}\label{signifier-matrix}}
...
\mysubsection{Signifier device}\label{signifier-device}}
...
Your device should have the general look and feel of a cube, even if you
...
\mysubsection{Revisit picking up a key}\label{revisit-picking-up-a-key}}
...
\mysubsection{Anti-signifier matrix}\label{anti-signifier-matrix}}
...
\mysubsection{Waiting in line}\label{waiting-in-line}}
...
\hypertarget{favorite-movie}{%
\mysubsection{Favorite movie}\label{favorite-movie}}
...
\hypertarget{packing}{%
\mysubsection{Packing}\label{packing}}
...
\mysubsection{Unoccupied room}\label{unoccupied-room}}
...
\mysubsection{Two characters}\label{two-characters}}
...
\mysubsection{Captions}\label{captions}}
...
\emph{Begin excerpt from \textbf{1984}}
...
The Ministry of Truth--Minitrue, in Newspeak \([\)Newspeak was the
...
\mysubsection{Exercise reflection}\label{exercise-reflection}}
...
Each time you offer or receive a critique, you may find yourself in the
...
A famous quote, popularized by William S. Burroughs in \emph{Naked
...
Information comes in many forms and has many characteristics. You should
...
\mysubsection{Exercise objectives}\label{exercise-objectives}}
...
The problem exemplifies the long-standing clash between holistic design
as described in the classic \emph{Zen and the Art of Motorcycle
Maintenance} and analysis-based design, more concerned with enumeration
of features than with user experience. IoT startups may be the latest in
a series of feature-lists-as-design victims.
...
\mysection{References}\label{references}}

\phantom{XXX}

\hypertarget{refs}{}
\begin{CSLReferences}{1}{0}
\leavevmode\vadjust pre{\hypertarget{ref-Arnheim1974}{}}%
Arnheim, Rudolf. 1974. \emph{Art and Visual Perception}. Berkeley, CA:
University of California Press.

\leavevmode\vadjust pre{\hypertarget{ref-Bannon2018}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Chi1997}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Holtzblatt2005}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Irani2010}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Nelms1964}{}}%
Nelms, Henning. 1964. \emph{Thinking with a Pencil}. New York: {Barnes
\& Noble}.

\leavevmode\vadjust pre{\hypertarget{ref-Newell2011}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Newell2000}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Pirolli1999}{}}%
Pirolli, Peter, and Stuart Card. 1999. {``Information Foraging.''}
\emph{Psychological Review} 106 (4): 643--75.

\leavevmode\vadjust pre{\hypertarget{ref-Proenca2016}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Pruitt2003}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Shinohara2012}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Shinohara2016}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Shugrina2019}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Spencer2009}{}}%
Spencer, Donna. 2009. \emph{Card Sorting: Designing Usable Categories}.
Brooklyn, NY: Rosenfeld Media.

\leavevmode\vadjust pre{\hypertarget{ref-Spinuzzi2000}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Spruit2015}{}}%
