...
## Recap
- In the first half, we explored an approach to interaction design where you
  - conduct a contextual inquiry to understand the user's situation
  - develop personas who fit into that situation
  - construct scenarios that those personas enact
  - create prototypes that will succeed in those scenarios
- The second half is information design

## Information design
- To understand it, we must take a detour through information
- The easiest way to understand information is to start with personal information
- Why?
- Because it's familiar to everyone
- You all have personal information
- Maybe passwords, calendars, todo lists, notes, health info, ...

# What about information?
- Information can be controversial to define
- Widespread agreement exists, though, about some properties and uses of information.
- We can start to explore that through personal information
...
- Information from it (and several subsequent workshsops) was saved at
  [PIM Resources](http://pim.ischool.washington.edu/index.htm), which no longer exists (a good substitute is at [PIM Resources](https://pim.famnit.upr.si/wiki/index.php/Personal_Information_Management_(PIM)_resources))
...
::: {.notes}
The PIM Resources link doesn't work as of 2024-10-14 09:57 and the Wayback Machine is currently under DDOS attack, so it can't be retrieved from there. The Wikipedia page on Personal Information Management contains links to some of the workshop materials.
:::
...
(Researchers define these three words differently, e.g., classifications are labeled groups, while clusters are unlabeled groups. Some definitions include the notion of a hierarchy.)
...
1. Form a pair.
2. Share a google doc between you two and me.
3. Each person writes three paragraphs describing your personal information process: (1) what you do, (2) what works well about it, and (3) what does not work well about it.
4. Discuss the resulting paragraphs
5. Write two paragraphs as a pair describing (1) what strengths you agree on, and (2) what weaknesses you agree on. An optional third paragraph describes your disagreements.
...
Forbes was a US magazine for decades before it
created an online presence. It cultivates an image
as a maverick business publication, espousing
values favoring considerable social and economic
freedom for individuals, i.e., libertarianism, and
a blunt style, connecting business success to
...
- Features: open source, plain text data storage, encryption, filtering, pinning, tagging, search, Git-backed versioning and syncing, Pandoc-based conversion, wiki-style linking, terminal and gui web browsing, inline images, todos with tasks, notebooks, folders, color themes, plugins
...
- Not yet widely discussed on Hacker News (at least in comparison to Notion and Obsidian)
