...
Design is not rocket science. For the most part, there are not secrets. You are competing with people who can do the same things you can do. If you can do them faster, you have a distinct advantage.
:::
...
::: {.notes}
*Visual design* is a field that has long been concerned with aesthetics, so they are less focused on the user than are other fields.

*Social work* is more focused on the community than are other fields. In particular, they study the impact of technology on underserved groups. They take a critical view of the user experience offered by Big Tech.

*Product design* is more focused on market segmentation than the other disciplines that care about user experience.
:::
...
witness (and reported on previously) was a CHI design competition where an
Indian student had devised a hardware / software platform to assist bus
conductors in a rural state. This was a small tablet-like device that would be
carried by the conductor who would talk to the passengers to learn their
destinations and enter them into the device, and be able to shout out stops to
the driver at appropriate times. It was a complicated bottlenecky system.
To show the audience that there were conductors on buses and
...
![](fiDisabilitiesIncCognitive.png)
...
There is that aspect of a thing you can interact with that
suggests how to interact with it

It can be done well or poorly

It is the central concept for individual user

It is often skeuomorphic
