...
##
![](fiRelationHierarchyNetwork.png)
...
##
![](fiPoliticalBlogs.png)

::: {.notes}
For example, this visualization by @Adamic2005 of the community structure of political blogs, made the cover of the New York Times, due to its graphic demonstration of the polarization of US politics. The notable feature is that it is rare for the blue and red blogs to connect to any blogs with dissimilar views.
:::
...
##
![](fiSelfishGeneCover.png)

::: {.notes}
The Selfish Gene (1976) slipcover
:::
...
- A-B testing is the most common tool for understanding navigational behavior between two items (and for multiple items, the multi-armed bandit)
...
::: {.notes}
Card sort is a means of understanding the labels people use to describe things of interest. There can be cognitive dissonance in the labeling of information containers and card sorting as a means to overcome it. We can connect the concepts of information hiding and labeling to see how labeling helps to limit information overload.
:::
...
## Wikipedia definition of Cohen's 𝜅
...
::: {.notes}
The score should be smaller than the percent agreement although your results should differ from mine because we're both using random number generators. When I last ran it, 𝜅 was negative. Different books recommend different cutoffs for an acceptable 𝜅 value for action. I was taught 0.7. The appropriate procedure if you have a lower 𝜅 is to discuss your views and re-rate independently. In other words, you discuss your views without looking at specific items then re-rate without looking at each other's items.
...
Light's 𝜅 is briefly described in @Hallgren2012. That tutorial gives R code for several versions of 𝜅, including Cohen's weighted 𝜅, described above as `kappa2()`, and both Fleiss's and Light's 𝜅.
...
##
![](fiPatternLanguageCover.jpg)

::: {.notes}
This is the cover of the first of Alexander's books describing his architectural ideas.
:::
...
##
![](fiDesignPatternsCover.jpg)

::: {.notes}
This is the cover of the book that revolutionized software design for the next decade. This book popularized object-oriented design.
:::
...
Fonts are *Roboto* and *Roboto Light*, as well as *STIX TWO Math* for math
