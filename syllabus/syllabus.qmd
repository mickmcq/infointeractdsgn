...
## Canvas
[https://utexas.instructure.com/courses/1456631](https://utexas.instructure.com/courses/1456631)
...
## Notebook
You should bring a paper notebook to class every day and be prepared to upload pictures from it frequently. The notebook should be the size of the Moleskine Cahier notebook, 5 $\times$ 8.25 inches. It is widely available in packs of three for about 15 [usd]{.smallcaps}. Substitute any sketchbook of similar size, e.g., Malvern Books has Leuchturm sketchbooks, which have higher quality paper than Moleskine but are more expensive. Why do I insist on this size? You actually draw differently on larger notebooks due to the average shape and size of the human hand.
